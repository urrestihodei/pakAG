...
public class dbKontsultak {
    ...
    public static List<Langilea> getLangileHistoriala(String nan) {
        ...
        try {
            Statement stmt = konexioa.konexioaHasi().createStatement();
            ResultSet rs = stmt.executeQuery("SELECT langilea.langilea_izena, langilea.langilea_abizena, historiala.entrega_data, bezeroa.bezeroa_helbidea " +
                    "FROM langilea " +
            ...
            while (rs.next()) {
                ...
                Langilea langilea = new Langilea(izena, abizena, entrega_data, helbidea);
