	...
	public Kudeatu() {
		...
		bantzaileaKudeatu.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		        ...
		        List<Langilea> banatzaileaList = dbKontsultak.getErabiltzaileak();
	            	...
	            	sartuBtn.addActionListener(new ActionListener() {
	        			...
	        			public void actionPerformed(ActionEvent e) {
	        			      JPanel panel = new JPanel(new GridLayout(0, 2));
	        			        ...
	        			        List<String> banatzaileaList = dbKontsultak.getErabiltzaileak2();
		...
		historiala.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				historialaPanel.add(new JLabel("Historiala:"), BorderLayout.NORTH);
				List<Historiala> historialaList = dbKontsultak.paketeHistoriala();
				StringBuilder labelText = new StringBuilder("<html>");
				for (Historiala historiala : historialaList) {
				    labelText.append(historiala.toString()).append("<br>");
				}
				labelText.append("</html>");

				JLabel lblHistoriala = new JLabel(labelText.toString());
				historialaPanel.add(lblHistoriala, BorderLayout.CENTER);
